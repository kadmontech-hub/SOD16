...
assert.match(sw,/sod-shell-v3\.(?:0\.(?:4(?:-hub-icons|\.2-safe-access)?|5-library-v5|6-library-abundant|7-videoteca)|1\.0-conversation)/);
assert.match(pkg,/"version": "3\.(?:0\.(?:4|5)|1\.0)"/);
